...
async def killdabot(event):
    ...
    await event.edit("`Matikan Baphomet....`")
...
async def killdabot(event):
    await event.edit("`Reinkarnasi Baphomet....`")
    await asyncio.sleep(10)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#Restart \n"
                                        "Baphomet sedang dihidupkan kembali!")
    await bot.disconnect()
...
async def reedme(e):
    await e.edit(
        ...
        "\n[Yama README.md file](https://github.com/bryanasfuk/Baphomet/blob/sql-extended/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "[Baphomet](https://github.com/bryanasfuk/Baphomet)\n"
    )
